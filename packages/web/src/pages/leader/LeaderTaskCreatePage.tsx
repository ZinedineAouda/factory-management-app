...
const LeaderTaskCreatePage: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    deadline: '',
    taskType: 'production' as 'production' | 'maintenance',
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.taskType === 'production' && (!formData.groupId || !formData.productId)) {
      setError('Production tasks require both group and product');
      return;
    }

    if (formData.taskType === 'maintenance' && !formData.groupId) {
      setError('Maintenance tasks require a group');
      return;
    }
...
export default LeaderTaskCreatePage;
